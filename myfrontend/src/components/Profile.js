...
function Profile({email2}) {
    ...
    if(banned){
        ...
        return (
            ...
            :null}
            {value12.email2==="Login"||profilestatus==="My Profile"?null:<Button onClick={()=>getConversation()} style={{marginLeft:'49%',backgroundColor: '#11204D', marginTop:'2%' }}><ChatFill /> </Button>}
