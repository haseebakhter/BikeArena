...
function Purchases() {
    ...
    const getData=()=>{
        axios.get('http://localhost:5000/getpurchases')
            .then(response => {
        ...
        <div>
            ...
            {purchases.map(purchase=>(
                ...
                <div>
                    ...
                    <a style={{fontSize:'30px', display:'inline-block', marginLeft:'10%'}} href={'/ad/'+purchase.PurchasedAd._id}  >{purchase.PurchasedAd.adtitle}</a>
